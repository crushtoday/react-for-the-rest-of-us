    ...
    switch (action.type) {
      ...
      case "usernameUniqueResults":
        if (action.value) {
          ...
          draft.username.message = "That username is alreadt taken"
        } else {
      ...
      case "passwordAfterDelay":
        ...
        return
      case "submitForm":
        if (!draft.username.hasErrros && draft.username.isUnique && !draft.email.hasErrors && draft.email.isUnique && !draft.password.hasErrors) {
          draft.submitCount++
        }
        return
    }
        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <small>Must be between 12-15 characters long</small>
            </div>
